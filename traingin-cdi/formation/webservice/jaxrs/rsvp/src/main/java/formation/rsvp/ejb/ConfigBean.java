...
package formation.rsvp.ejb;

import java.util.Calendar;
import java.util.GregorianCalendar;
import java.util.logging.Logger;
import formation.rsvp.entity.Event;
import formation.rsvp.entity.Person;
import formation.rsvp.entity.Response;
import formation.rsvp.util.ResponseEnum;
...
public class ConfigBean {
    ...
    private static final Logger logger = Logger.getLogger("formation.rsvp.ejb.ConfigBean");
